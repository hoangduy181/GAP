#!/usr/bin/env python3
"""
Quick test script for NTU60 YOLO Pose Loader
...
def quick_test():
    ...
    print("=" * 70)
    print("Quick NTU60 YOLO Loader Test")
    print("=" * 70)
    ...
    try:
        ...
        if data.shape != (2, 64, 17, 1):
            print(f"❌ ERROR: Expected shape (2, 64, 17, 1), got {data.shape}")
            return False
