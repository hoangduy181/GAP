#!/usr/bin/env python3
"""
Parse training log file and create CSV files and visualization graphs for loss and accuracy.
"""
...
def main():
    ...
    log_path = 'ntu60_2d_ctr_gcn_log.txt'
    
    # Parse log file
    print(f"Parsing log file: {log_path}")
    train_data, eval_data = parse_log_file(log_path)
    print(f"  Found {len(train_data)} training epochs and {len(eval_data)} eval epochs")
